...
class Fish extends Phaser.Sprite {
    ...
    _flock(swarm, targetDir) {
        let cohesion = this._cohere(swarm, target).multiply(this.COHESION_FACTOR,this.COHESION_FACTOR);
        ...
        let target = this._steerTo(targetDir);//.multiply(this.TARGET_FACTOR,this.TARGET_FACTOR);
        //let target = targetDir.multiply(this.TARGET_FACTOR,this.TARGET_FACTOR);
